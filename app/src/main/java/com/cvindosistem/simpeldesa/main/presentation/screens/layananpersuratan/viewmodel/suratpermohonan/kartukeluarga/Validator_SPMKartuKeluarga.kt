...
class SPMKartuKeluargaValidator(private val stateManager: SPMKartuKeluargaStateManager) {
    ...
    fun validateStep1(): Boolean {
        ...
        with(stateManager) {
            ...
            if (noKkValue.isBlank()) {
                errors["no_kk"] = "No KK tidak boleh kosong"
            ...
            if (alasanPermohonanValue.isBlank()) errors["alasan_permohonan"] = "Alasan permohonan tidak boleh kosong"
        }

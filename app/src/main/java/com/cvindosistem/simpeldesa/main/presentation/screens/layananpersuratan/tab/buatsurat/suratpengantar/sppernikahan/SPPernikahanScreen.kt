package com.cvindosistem.simpeldesa.main.presentation.screens.layananpersuratan.tab.buatsurat.suratpengantar.sppernikahan
...
fun SPPernikahanScreen(
    ...
    Scaffold(
        ...
        AppStepAnimatedContent(
            ...
            when (step) {
                1 -> SPPernikahan1Content()
                2 -> SPPernikahan2Content()
                3 -> SPPernikahan3Content()
                4 -> SPPernikahan4Content()
                5 -> SPPernikahan5Content()
            }
        }
    }
}
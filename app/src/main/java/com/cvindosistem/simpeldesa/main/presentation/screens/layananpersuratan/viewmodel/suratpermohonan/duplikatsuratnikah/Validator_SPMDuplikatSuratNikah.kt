...
class SPMDuplikatSuratNikahValidator(private val stateManager: SPMDuplikatSuratNikahStateManager) {
    ...
    fun validateStep1(): Boolean {
        ...
        with(stateManager) {
            ...
            if (noKkValue.isBlank()) errors["no_kk"] = "No KK tidak boleh kosong"
    ...
    fun validateStep2(): Boolean {
        ...
        with(stateManager) {
            ...
            if (tanggalNikahValue.isBlank()) errors["tanggal_nikah"] = "Tanggal nikah tidak boleh kosong"
            if (kepalaKeluargaValue.isBlank()) errors["kepala_keluarga"] = "Kepala keluarga tidak boleh kosong"
            if (kecamatanKuaValue.isBlank()) errors["kecamatan_kua"] = "Kecamatan KUA tidak boleh kosong"
        }

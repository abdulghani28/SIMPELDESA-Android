...
class SPPermohonanPenerbitanBukuPasLintasBatasDataLoader(
    ...
    private val validator: SPPermohonanPenerbitanBukuPasLintasBatasValidator
) {
            ...
            when (val result = getUserInfoUseCase()) {
                is UserInfoResult.Success -> {
                    ...
                    validator.clearMultipleFieldErrors(listOf(
                        ...
                        "kewarganegaraan", "agama_id", "pekerjaan", "status_kawin_id", "alamat"
                    ))
                    Result.success(Unit)
                }

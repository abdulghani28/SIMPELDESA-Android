...
class SKJamkesosValidator(private val stateManager: SKJamkesosStateManager) {
    ...
    fun validateStep2(): Boolean {
        ...
        with(stateManager) {
            if (noKartuValue.isBlank()) errors["no_kartu"] = "Nomor kartu tidak boleh kosong"
            if (berlakuDariValue.isBlank()) errors["berlaku_dari"] = "Tanggal berlaku dari tidak boleh kosong"
            if (berlakuSampaiValue.isBlank()) errors["berlaku_sampai"] = "Tanggal berlaku sampai tidak boleh kosong"
        }

            ...
            when (val result = getUserInfoUseCase()) {
                is UserInfoResult.Success -> {
                    ...
                    validator.clearMultipleFieldErrors(listOf(
                        "nik_suami", "nama_suami", "alamat_suami", "pekerjaan_suami",
                        "tanggal_lahir_suami", "tempat_lahir_suami", "agama_id_suami"
                    ))
                    Result.success(Unit)
                }

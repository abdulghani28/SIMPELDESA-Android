...
fun SKTidakMasukKerjaScreen(
    ...
    val currentStep by remember { derivedStateOf { skTidakMasukKerjaViewModel.currentStep } }
    val showConfirmationDialog by remember { derivedStateOf { skTidakMasukKerjaViewModel.showConfirmationDialog } }
    val showPreviewDialog by remember { derivedStateOf { skTidakMasukKerjaViewModel.showPreviewDialog } }
    val isLoading by remember { derivedStateOf { skTidakMasukKerjaViewModel.isLoading } }
    val hasFormData by remember { derivedStateOf { skTidakMasukKerjaViewModel.hasFormData() } }
    val totalSteps = 2
    ...
    LaunchedEffect(skTidakMasukKerjaViewModel.skTidakMasukKerjaEvent) {
        skTidakMasukKerjaViewModel.skTidakMasukKerjaEvent.collect { event ->
            when (event) {
                is SKTidakMasukKerjaViewModel.SKTidakMasukKerjaEvent.SubmitSuccess -> {
                ...
                is SKTidakMasukKerjaViewModel.SKTidakMasukKerjaEvent.SubmitError -> {
                    errorDialogTitle = "Gagal Mengirim"
                    errorDialogMessage = event.message
                    showErrorDialog = true
                }
                is SKTidakMasukKerjaViewModel.SKTidakMasukKerjaEvent.UserDataLoadError -> {
                    errorDialogTitle = "Gagal Memuat Data"
                    errorDialogMessage = event.message
                    showErrorDialog = true
                }
                is SKTidakMasukKerjaViewModel.SKTidakMasukKerjaEvent.ValidationError -> {
                    snackbarHostState.showSnackbar(
                        message = "Mohon lengkapi semua field yang diperlukan",
                        duration = SnackbarDuration.Short
                    )
                }
                is SKTidakMasukKerjaViewModel.SKTidakMasukKerjaEvent.StepChanged -> {
    ...
    Scaffold(
        ...
        bottomBar = {
            AppBottomBar(
                onPreviewClick = {
                    skTidakMasukKerjaViewModel.showPreview()
                },
                onBackClick = if (currentStep > 1) {
                    { skTidakMasukKerjaViewModel.previousStep() }
                } else null,
                onContinueClick = if (currentStep < totalSteps) {
                    { skTidakMasukKerjaViewModel.nextStep() }
                } else null,
                onSubmitClick = if (currentStep == totalSteps) {
                    { skTidakMasukKerjaViewModel.showConfirmationDialog() }
                } else null
            )
        }
    ) { paddingValues ->
        Box(modifier = Modifier.padding(paddingValues)) {
            ...
            if (showPreviewDialog) {
                PreviewDialog(
                    viewModel = skTidakMasukKerjaViewModel,
                    onDismiss = {
                        skTidakMasukKerjaViewModel.dismissPreview()
                    },
                    onSubmit = {
                        skTidakMasukKerjaViewModel.dismissPreview()
                        skTidakMasukKerjaViewModel.showConfirmationDialog()
            ...
            if (showConfirmationDialog) {
                SubmitConfirmationDialog(
                    onConfirm = {
                        skTidakMasukKerjaViewModel.confirmSubmit()
                    },
                    onDismiss = {
                        skTidakMasukKerjaViewModel.dismissConfirmationDialog()
                    },
                    onPreview = {
                        skTidakMasukKerjaViewModel.dismissConfirmationDialog()
                        skTidakMasukKerjaViewModel.showPreview()
            ...
            if (showErrorDialog) {
                ErrorDialog(
                    ...
                    onDismiss = {
                        ...
                        skTidakMasukKerjaViewModel.clearError()
                    }
                )
            }
            ...
            item {
                PreviewSection(
                    ...
                    content = {
                        ...
                        PreviewItem("Lama Izin", viewModel.lamaValue.toString())
                        PreviewItem("Terhitung dari Tanggal", dateFormatterToApiFormat(viewModel.terhitungDariValue))
                        PreviewItem("Alasan Izin", viewModel.alasanIzinValue)
                    }
                )
            }
        }

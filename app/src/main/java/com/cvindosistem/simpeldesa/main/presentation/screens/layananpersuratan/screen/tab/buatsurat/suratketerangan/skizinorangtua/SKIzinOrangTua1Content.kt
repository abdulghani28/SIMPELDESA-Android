...
@Composable
internal fun SKIzinOrangTua1Content(
...
@Composable
private fun InformasiPemberiIzinSection(
    viewModel: SKIzinOrangTuaViewModel
) {
    Column {
        SectionTitle("Informasi Pemberi Izin")
        Spacer(modifier = Modifier.height(16.dp))

        AppTextField(
            label = "Yang Memberi Izin",
            placeholder = "Contoh: Orang Tua/Suami/Istri/Keluarga.",
            value = viewModel.memberiIzinValue,
            onValueChange = viewModel::updateMemberiIzin,
            isError = viewModel.hasFieldError("memberi_izin"),
            errorMessage = viewModel.getFieldError("memberi_izin")
        )

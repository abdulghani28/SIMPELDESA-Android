...
fun SKResiKTPSementaraScreen(
    ...
    val showConfirmationDialog by remember { derivedStateOf { sKResiKTPSementaraViewModel.showConfirmationDialog } }
    val showPreviewDialog by remember { derivedStateOf { sKResiKTPSementaraViewModel.showPreviewDialog } }
    val isLoading by remember { derivedStateOf { sKResiKTPSementaraViewModel.isLoading } }
    val hasFormData by remember { derivedStateOf { sKResiKTPSementaraViewModel.hasFormData() } }
    val validationErrors by sKResiKTPSementaraViewModel.validationErrors.collectAsState()
    ...
    LaunchedEffect(sKResiKTPSementaraViewModel.catatanResiKTPSementaraEvent) {
        sKResiKTPSementaraViewModel.catatanResiKTPSementaraEvent.collect { event ->
            when (event) {
                is SKResiKTPSementaraViewModel.SKResiKTPSementaraEvent.SubmitSuccess -> {
                ...
                is SKResiKTPSementaraViewModel.SKResiKTPSementaraEvent.SubmitError -> {
                    errorDialogTitle = "Gagal Mengirim"
                    errorDialogMessage = event.message
                    showErrorDialog = true
                }
                is SKResiKTPSementaraViewModel.SKResiKTPSementaraEvent.UserDataLoadError -> {
                    errorDialogTitle = "Gagal Memuat Data"
                    errorDialogMessage = event.message
                    showErrorDialog = true
                }
                is SKResiKTPSementaraViewModel.SKResiKTPSementaraEvent.ValidationError -> {
                    snackbarHostState.showSnackbar(
                        message = "Mohon lengkapi semua field yang diperlukan",
                        duration = SnackbarDuration.Short
                    )
                }
                is SKResiKTPSementaraViewModel.SKResiKTPSementaraEvent.StepChanged -> {
                ...
                is SKResiKTPSementaraViewModel.SKResiKTPSementaraEvent.AgamaLoadError -> {
    ...
    Scaffold(
        ...
        bottomBar = {
            AppBottomBar(
                onPreviewClick = { sKResiKTPSementaraViewModel.showPreview() },
                onSubmitClick = { sKResiKTPSementaraViewModel.showConfirmationDialog() }
            )
        }
    ) { paddingValues ->
        FormSectionList(
            ...
            item {
                UseMyDataCheckbox(
                    checked = sKResiKTPSementaraViewModel.useMyDataChecked,
                    onCheckedChange = sKResiKTPSementaraViewModel::updateUseMyData,
                    isLoading = sKResiKTPSementaraViewModel.isLoadingUserData
                )
            }

            item {
                InformasiPelapor(
                    viewModel = sKResiKTPSementaraViewModel,
        ...
        if (showPreviewDialog) {
            PreviewDialog(
                viewModel = sKResiKTPSementaraViewModel,
                onDismiss = {
                    sKResiKTPSementaraViewModel.dismissPreview()
                },
                onSubmit = {
                    sKResiKTPSementaraViewModel.dismissPreview()
                    sKResiKTPSementaraViewModel.showConfirmationDialog()
                }
            )
        }
        ...
        if (showConfirmationDialog) {
            SubmitConfirmationDialog(
                onConfirm = {
                    sKResiKTPSementaraViewModel.confirmSubmit()
                },
                onDismiss = {
                    sKResiKTPSementaraViewModel.dismissConfirmationDialog()
                },
                onPreview = {
                    sKResiKTPSementaraViewModel.dismissConfirmationDialog()
                    sKResiKTPSementaraViewModel.showPreview()
                }
            )
        }
        ...
        if (showErrorDialog) {
            ErrorDialog(
                ...
                onDismiss = {
                    ...
                    sKResiKTPSementaraViewModel.clearError()
                }
            )
        }

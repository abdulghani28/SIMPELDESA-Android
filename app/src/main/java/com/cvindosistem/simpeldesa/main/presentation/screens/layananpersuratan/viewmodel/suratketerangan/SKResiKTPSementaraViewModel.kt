            ...
            try {
                when (val result = getUserInfoUseCase()) {
                    ...
                    is UserInfoResult.Error -> {
                        ...
                        _catatanResiKTPSementaraEvent.emit(SKResiKTPSementaraEvent.UserDataLoadError(result.message))
                    }
                }
            } catch (e: Exception) {
                errorMessage = e.message ?: "Gagal memuat data pengguna"
                useMyDataChecked = false
                _catatanResiKTPSementaraEvent.emit(SKResiKTPSementaraEvent.UserDataLoadError(errorMessage!!))
            } finally {
            ...
            try {
                when (val result = getAgamaUseCase()) {
                    ...
                    is AgamaResult.Error -> {
                        ...
                        _catatanResiKTPSementaraEvent.emit(SKResiKTPSementaraEvent.AgamaLoadError(result.message))
                    }
                }
            } catch (e: Exception) {
                agamaErrorMessage = e.message ?: "Gagal memuat data agama"
                _catatanResiKTPSementaraEvent.emit(SKResiKTPSementaraEvent.AgamaLoadError(agamaErrorMessage!!))
            } finally {
            ...
            try {
                ...
                when (val result = createSuratCatatanResiKTPSementaraUseCase(request)) {
                    ...
                    is SuratResiKTPSementaraResult.Error -> {
                        errorMessage = result.message
                        _catatanResiKTPSementaraEvent.emit(SKResiKTPSementaraEvent.SubmitError(result.message))
                    }
                }
            } catch (e: Exception) {
                errorMessage = e.message ?: "Terjadi kesalahan"
                _catatanResiKTPSementaraEvent.emit(SKResiKTPSementaraEvent.SubmitError(errorMessage!!))
            } finally {
                isLoading = false
            }
        }

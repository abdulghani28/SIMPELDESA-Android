...
private fun InformasiUsaha(
    ...
    Column {
        ...
        AppTextField(
            ...
            value = viewModel.pendatangNamaUsahaValue,
            onValueChange = { viewModel.updatePendatangNamaUsaha(it) },
        ...
        MultilineTextField(
            ...
            value = viewModel.pendatangAlamatUsahaValue,
            onValueChange = { viewModel.updatePendatangAlamatUsaha(it) },
